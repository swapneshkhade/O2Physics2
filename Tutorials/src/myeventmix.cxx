...
struct MixedEvents {
  ...
  SameKindPair<aod::Collisions, aod::Tracks, BinningType> pair{binningOnPositions, 10, -1}; // indicates that 5 events should be mixed and under/overflow (-1) to be ignored
